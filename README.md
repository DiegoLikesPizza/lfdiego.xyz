...
│  ├─ wiki/page.tsx     # /wiki — index of the visual guides
│  ├─ wiki/[slug]/      # /wiki/<guide> — one static page per guide
...
│  └─ wiki/             # guide content (guides/*.tsx), diagram primitives, event-loop stepper
├─ data/
